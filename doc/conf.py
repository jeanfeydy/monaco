...
def linkcode_resolve(domain, info):
    ...
    if domain != 'py' or not info['module']:
        return None
    try:
        filename = 'monaco/%s#L%d-L%d' % find_source()
    except Exception:
...
html_short_title = "Monaco documentation"
...
latex_documents = [
    (master_doc, 'Monaco.tex', 'Monaco Documentation',
     'Anonymous', 'manual'),
]
...
man_pages = [
    (master_doc, 'monaco', 'Monaco Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Monaco', 'Monaco Documentation',
     author, 'Monaco', 'GPU accelerated collective Monte Carlo methods.',
     'Miscellaneous'),
]
