...
try:
    ...
    sys.path.insert(0, os.path.abspath("../../keops"))
    import pykeops
...
latex_documents = [
    (master_doc, "Monaco.tex", "Monaco Documentation", "Anonymous", "manual"),
]
...
man_pages = [(master_doc, "monaco", "Monaco Documentation", [author], 1)]
